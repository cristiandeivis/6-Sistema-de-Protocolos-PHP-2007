...
<form name="form1" method="post" action="../alterar_protocolo/mostra_protocolo.php">
  <div align="center">
    <p><img src="../imagens_fundo/alterarprotocolo.gif" width="147" height="23"></p>
  </div>
  <table width="96%" border="1" align="center">
    <tr> 
      <td width="12%" height="11"><font face="Courier New, Courier, mono">Data: 
        </font></td>
      <td colspan="3"><input name="data" type="text" id="enviar_data" size="20" OnKeyPress="formatar('##/##/####', this)"> 
      </td>
    </tr>
    <tr> 
      <td height="28"><font face="Courier New, Courier, mono">Empresa:</font></td>
