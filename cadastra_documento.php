<html>
<head>
<title>cadastra_documento</title>
...
<table width="590" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="517"><div align="center"><img src="imagens_fundo/cadastrodocumento.gif" width="192" height="23"><br>
        <br>
      </div></td>
    <td width="53">&nbsp;</td>
  </tr>
  <tr>
    <td height="126">&nbsp;</td>
    <td valign="top"> 
      <form action="confirma_cadastro_documento.php" method="post" name="form1" id="form1">
        <table width="91%" border="1" align="center" cellpadding="1">
          <tr> 
            <td width="41%"><div align="left"><font color="#000099" face="Courier New, Courier, mono">Nome 
                do Documento: </font></div></td>
            <td width="59%"><input name="nome_documento" type="text" id="nome_documento" size="41"></td>
          </tr>
          <tr> 
